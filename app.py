...
<div class="app-container">
    ...
    <div class="center-column">
        ...
        <div class="focus-block" id="focusBlock">
            ...
            <div class="empty-block" id="focusEmpty">+ Добавить задачу в фокус</div>
        </div>
        ...
        <div class="block-row">
            <div class="block block-important" id="importantBlock">
                ...
                <div class="empty-block" id="importantEmpty">+ Добавить задачу</div>
            </div>
            <div class="block block-medium" id="mediumBlock">
                ...
                <div class="empty-block" id="mediumEmpty">+ Добавить задачу</div>
            </div>
            <div class="block block-later" id="laterBlock">
                ...
                <div class="empty-block" id="laterEmpty">+ Добавить задачу</div>
            </div>
        </div>
    </div>
    ...
    <div class="right-column">
        <div class="sidebar-card">
            <button class="big-btn" id="toggleQuartersBtn">🗓️ 3 месяца</button>
            <div class="quarter-popup" id="quarterPopup">
                <button class="close-popup" id="closePopupBtn">✕</button>
                <h4>Выберите квартал</h4>
                <button class="q-btn">❄️ Январь – Март <span class="q-sub" style="font-size:11px;color:#888;display:block;">2026</span></button>
                <button class="q-btn">🌸 Апрель – Июнь <span class="q-sub" style="font-size:11px;color:#888;display:block;">2026</span></button>
                <button class="q-btn">☀️ Июль – Сентябрь <span class="q-sub" style="font-size:11px;color:#888;display:block;">2026</span></button>
                <button class="q-btn">🍂 Октябрь – Декабрь <span class="q-sub" style="font-size:11px;color:#888;display:block;">2026</span></button>
            </div>
        </div>
    </div>
</div>
